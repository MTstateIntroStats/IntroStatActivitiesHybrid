...
Activities 7--9 cover the material in Module 4.  For more practice with theory-based confidence intervals for a single categorical variable use the Module 4 Review worksheet in the Unit 1 Review Materials (pgs. 109--113).
