## Activity 19: Moon Phases and Virtual Reality
...
The sampling distribution for $\bar{y}_1-\bar{y}_2$ can be modeled using a normal distribution when certain conditions are met.

**Conditions for the sampling distribution of $\bar{y}_1 - \bar{y}_2$ to follow an approximate normal distribution**:

* **Independence**: the sample’s observations are independent and there is independence between groups. (*Remember*: This also must be true to use simulation methods!)
...
\begin{center}\includegraphics[width=0.7\linewidth]{11-A19-inference-1ofeach-theory_files/figure-latex/unnamed-chunk-2-1} \end{center}
