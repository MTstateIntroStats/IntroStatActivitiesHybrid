## Activity 21:  Color Interference
...
In general, the sampling distribution for a sample mean, $\bar{y}$, based on a sample of size $n$ from a population with a true mean $\mu$ and true standard deviation $\sigma$ can be modeled using a Normal distribution when certain conditions are met.  Note, that since we are treating paired data as a single mean, the conditions are the same as for a single mean.
...
\begin{center}\includegraphics[width=0.7\linewidth]{12-A21-paired-theory_files/figure-latex/unnamed-chunk-2-1} \includegraphics[width=0.7\linewidth]{12-A21-paired-theory_files/figure-latex/unnamed-chunk-2-2} \end{center}
...
$$T = \frac{\bar{y}_d - \mu_0}{SE(\bar{y}_d)},$$
...
$$\bar{y}_d\pm t^* \times SE(\bar{y}_d).$$
...
Like with a single mean, for paired data we will need to *shift* each data point by the difference $\mu_0 - \bar{y}_d$.  
...
\begin{center}\includegraphics[width=0.7\linewidth]{12-A21-paired-theory_files/figure-latex/unnamed-chunk-6-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{12-A21-paired-theory_files/figure-latex/unnamed-chunk-7-1} \end{center}
