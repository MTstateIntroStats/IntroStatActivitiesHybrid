...
Module 12 will cover exploratory data analysis and both simulation-based and theory-based methods of inference for a quantitative response variable with paired samples. The **summary measure** for paired data is a **mean difference**. 

* Notation for a sample mean difference: $\bar{y}_d$
...
* **Conditions for the sampling distribution of $\bar{y}_d$ to follow an approximate normal distribution**:
