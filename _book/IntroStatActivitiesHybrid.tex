...
Condition: Observational units must be \textbf{independent}, meaning
...
\begin{itemize}
\item
  Find the proportion of \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ at least as extreme as the observed \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
\item
...
\item
  ...
  \tightlist
  \item
    Probability of observing the \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ or \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ assuming the \_\_\_\_\_\_\_\_\_\_\_\_ hypothesis is \_\_\_\_\_\_\_\_\_\_\_\_\_\_.
  \end{itemize}
\item
...
\rgi \rgi - The \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ the p-value, the \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ the evidence \textbf{against} the null hypothesis.
...
\begin{itemize}
\item
  Theory\_Based\_Inference
\item
  Theoretical\_Tests\_One\_Categorical\_Variable
\item
  Theoretical\_Intervals\_One\_Categorical\_Variable
\end{itemize}
...
\subsubsection*{Video: Theory-Based Inference (chapter 11)}\label{video-theory-based-inference-chapter-11}
\addcontentsline{toc}{subsubsection}{Video: Theory-Based Inference (chapter 11)}
...
\tightlist
\item
  Measures the number of \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ the statistic is above or below the null value
\end{itemize}
...
In a Normal curve, the area under the curve is equal to 1, representing a probability. Therefore the shaded area represents the \textbf{percentile} for Nell, or the probability of scoring less than or equal to 1800 points on the SAT.

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(openintro)}
\FunctionTok{normTail}\NormalTok{(}\AttributeTok{m =} \DecValTok{1500}\NormalTok{, }\AttributeTok{s =} \DecValTok{300}\NormalTok{, }\AttributeTok{L =} \DecValTok{1800}\NormalTok{)}
\FunctionTok{pnorm}\NormalTok{(}\AttributeTok{mean =} \DecValTok{1500}\NormalTok{, }\AttributeTok{sd =} \DecValTok{300}\NormalTok{, }\AttributeTok{q =} \DecValTok{1800}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{qnorm}\NormalTok{(}\AttributeTok{mean =} \DecValTok{21}\NormalTok{, }\AttributeTok{sd =} \DecValTok{5}\NormalTok{, }\AttributeTok{p =} \FloatTok{0.726}\NormalTok{)}
\CommentTok{\#\textgreater{} [1] 24.0038}
\FunctionTok{normTail}\NormalTok{(}\AttributeTok{m =} \DecValTok{21}\NormalTok{, }\AttributeTok{s =} \DecValTok{5}\NormalTok{, }\AttributeTok{L =} \DecValTok{24}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\subsubsection*{Video: Theoretical Tests for One Categorical Variable (section 14.3.1 and 14.3.2)}\label{video-theoretical-tests-for-one-categorical-variable-section-14.3.1-and-14.3.2}
\addcontentsline{toc}{subsubsection}{Video: Theoretical Tests for One Categorical Variable (section 14.3.1 and 14.3.2)}
...
\item
  This should give a similar value to the \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ of a simulated null distribution!
\end{itemize}
...
\tightlist
\item
  This value measures how many \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ the sample \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ is above/below the \_\_\_\_\_\_\_\_\_\_\_\_\_\_ \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_.
\end{itemize}

\setstretch{1}

Calculate the standard error of the sample proportion of payday loan borrowers that would support the regulation \emph{when assuming the null hypothesis is true}:
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{pnorm}\NormalTok{(}\FloatTok{0.59}\NormalTok{, }\AttributeTok{lower.tail =} \ConstantTok{FALSE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\subsubsection*{Video: Theoretical Confidence Intervals for One Categorical Variable (section 14.3.3)}\label{video-theoretical-confidence-intervals-for-one-categorical-variable-section-14.3.3}
\addcontentsline{toc}{subsubsection}{Video: Theoretical Confidence Intervals for One Categorical Variable (section 14.3.3)}
...
Calculate the standard error of the sample proportion of payday loan borrowers that would support the regulation \emph{when NOT assuming the null hypothesis is true}:
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{openintro}\SpecialCharTok{::}\FunctionTok{normTail}\NormalTok{(}\AttributeTok{m =} \DecValTok{0}\NormalTok{, }\AttributeTok{s =} \DecValTok{1}\NormalTok{, }\AttributeTok{L=}\FloatTok{1.96}\NormalTok{)}
\FunctionTok{qnorm}\NormalTok{(}\FloatTok{0.975}\NormalTok{, }\AttributeTok{lower.tail=}\ConstantTok{TRUE}\NormalTok{)}
...
\section{Activity 7: Handedness of Professional Male Boxers}\label{activity-7-handedness-of-professional-male-boxers}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{one\_proportion\_test}\NormalTok{(}\AttributeTok{probability\_success =} \FloatTok{0.1}\NormalTok{, }\CommentTok{\# Null hypothesis value}
          \AttributeTok{sample\_size =} \DecValTok{500}\NormalTok{, }\CommentTok{\# Enter sample size}
          \AttributeTok{number\_repetitions =} \DecValTok{10000}\NormalTok{, }\CommentTok{\# Enter number of simulations}
          \AttributeTok{as\_extreme\_as =} \FloatTok{0.162}\NormalTok{, }\CommentTok{\# Observed statistic}
          \AttributeTok{direction =} \StringTok{"greater"}\NormalTok{, }\CommentTok{\# Specify direction of alternative hypothesis}
          \AttributeTok{summary\_measure =} \StringTok{"proportion"}\NormalTok{) }\CommentTok{\# Reporting proportion or number of successes?}
\end{Highlighting}
\end{Shaded}
...
\begin{itemize}
\item
  \textbf{Independence}: The sample's observations are independent. (\emph{Remember}: This also must be true to use simulation methods!)
\item
...
Suppose that we want to show that the true proportion of professional male boxers \textbf{differs} from that in the general population.
...
\def\labelenumi{\arabic{enumi}.}
\item
  Both simulation and theory-based methods can be used to find a p-value for a hypothesis test. In order to use theory-based methods we need to check that both the independence and \textbf{the success-failure conditions} are met.
\item
...
\subsubsection*{Simulation methods}\label{simulation-methods-1}
...
\section{Activity 9: Impacts on the P-value and Confidence Interval}\label{activity-9-impacts-on-the-p-value-and-confidence-interval}
...
\FunctionTok{one\_proportion\_test}\NormalTok{(}\AttributeTok{probability\_success =} \FloatTok{0.1}\NormalTok{, }\CommentTok{\# Null hypothesis value}
          \AttributeTok{sample\_size =} \DecValTok{500}\NormalTok{, }\CommentTok{\# Enter sample size}
          \AttributeTok{number\_repetitions =} \DecValTok{10000}\NormalTok{, }\CommentTok{\# Enter number of simulations}
          \AttributeTok{as\_extreme\_as =} \FloatTok{0.128}\NormalTok{, }\CommentTok{\# Observed statistic}
          \AttributeTok{direction =} \StringTok{"greater"}\NormalTok{, }\CommentTok{\# Specify direction of alternative hypothesis}
          \AttributeTok{summary\_measure =} \StringTok{"proportion"}\NormalTok{) }\CommentTok{\# Reporting proportion or number of successes?}
\end{Highlighting}
\end{Shaded}
...
\tightlist
\item
  Note that this statistic (\(\frac{64}{500} = 0.128\)) is closer to the null value of 0.1 than the original statistic (\(\frac{81}{500}=0.1645\)). Is the p-value for this new study larger or smaller than for the original statistic?
\end{enumerate}
...
\tightlist
\item
  Calculate the standardized statistic for the new study using a sample proportion of 0.128 (\(\hat{p} = 0.128\)).
  \vspace{0.5in}
\end{enumerate}
...
\caption{Standard Normal Distribution}\label{fig:Norm-2}
\end{figure}
...
\subsubsection*{Change in sample size}\label{change-in-sample-size}
\addcontentsline{toc}{subsubsection}{Change in sample size}
...
\begin{Highlighting}[]
\FunctionTok{one\_proportion\_test}\NormalTok{(}\AttributeTok{probability\_success =} \FloatTok{0.1}\NormalTok{, }\CommentTok{\# Null hypothesis value}
          \AttributeTok{sample\_size =} \DecValTok{300}\NormalTok{, }\CommentTok{\# Enter sample size}
          \AttributeTok{number\_repetitions =} \DecValTok{10000}\NormalTok{, }\CommentTok{\# Enter number of simulations}
          \AttributeTok{as\_extreme\_as =} \FloatTok{0.162}\NormalTok{, }\CommentTok{\# Observed statistic}
          \AttributeTok{direction =} \StringTok{"greater"}\NormalTok{, }\CommentTok{\# Specify direction of alternative hypothesis}
          \AttributeTok{summary\_measure =} \StringTok{"proportion"}\NormalTok{) }\CommentTok{\# Reporting proportion or number of successes?}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{one\_proportion\_bootstrap\_CI}\NormalTok{(}\AttributeTok{sample\_size =} \DecValTok{500}\NormalTok{, }\CommentTok{\# Sample size}
                    \AttributeTok{number\_successes =} \DecValTok{81}\NormalTok{, }\CommentTok{\# Observed number of successes}
                    \AttributeTok{number\_repetitions =} \DecValTok{10000}\NormalTok{, }\CommentTok{\# Number of bootstrap samples to use}
                    \AttributeTok{confidence\_level =} \FloatTok{0.90}\NormalTok{) }\CommentTok{\# Confidence level as a decimal}
\end{Highlighting}
\end{Shaded}
...
\tightlist
\item
  Report both the 95\% confidence interval and the 90\% confidence interval (question 7). Is the 90\% confidence interval narrower or wider than the 95\% confidence interval?
\end{enumerate}

\vspace{0.5in}

\subsubsection*{Effect of sample size on the width of the confidence interval}\label{effect-of-sample-size-on-the-width-of-the-confidence-interval}
\addcontentsline{toc}{subsubsection}{Effect of sample size on the width of the confidence interval}
...
\tightlist
\item
  Compare the interval found in question 10 to the interval calculated in Activity 8 (prior to question 4).
\end{enumerate}
...
\tightlist
\item
  Using the width of the interval with the smaller sample size calculated in question 11, calculate the margin of error.
\end{enumerate}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{hearing }\SpecialCharTok{\%\textgreater{}\%} \CommentTok{\# Data set piped into...}
    \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ hearing\_loss)) }\SpecialCharTok{+}   \CommentTok{\# This specifies the variable}
    \FunctionTok{geom\_bar}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =} \FunctionTok{after\_stat}\NormalTok{(prop), }\AttributeTok{group =} \DecValTok{1}\NormalTok{)) }\SpecialCharTok{+}  \CommentTok{\# Tell it to make a bar plot with proportions}
    \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"Relative Frequency Bar Plot of Hearing Loss Status }\SpecialCharTok{\textbackslash{}n}\StringTok{ for US Teens"}\NormalTok{,  }
       \CommentTok{\# Give your plot a title}
       \AttributeTok{x =} \StringTok{"whether teen has hearing loss"}\NormalTok{,   }\CommentTok{\# Label the x axis}
       \AttributeTok{y =} \StringTok{"Relative Frequency"}\NormalTok{)  }\CommentTok{\# Label the y axis}
\end{Highlighting}
\end{Shaded}
...
\tightlist
\item
  What type of sampling bias may be present in this study? Explain.
\end{enumerate}
...
\item
  ...
  \vspace{0.8in}
\item
  Regardless to your answer in part i, calculate the standardized statistic.
  \vspace{0.8in}
\item
...
\begin{itemize}
\item
  \textbf{Sample standard deviation}, \(s\): on average, each value in the data set is \(s\) units from the mean of the data set (\(\bar{y}\)). We will always calculate \(s\) using R, but it is calculated using the following formula:
  \[
...
\section{Video Notes: Analysis of One Quantitative Variable}\label{video-notes-analysis-of-one-quantitative-variable}
...
\begin{itemize}
\item
  One\_Quantitative\_Variable\_Statistics
\item
  One\_Quantitative\_Variable\_Plots
\item
  Simulation\_Tests\_One\_Quantitative\_Variable
\item
  Bootstrap\_Intervals\_One\_Quantitative\_Variable
\end{itemize}

\setstretch{1}

\subsection*{Video: One Quantitative Variable - Statistics (sections 5.2, 5.4, 5.5 and 5.7)}\label{video-one-quantitative-variable---statistics-sections-5.2-5.4-5.5-and-5.7}
\addcontentsline{toc}{subsection}{Video: One Quantitative Variable - Statistics (sections 5.2, 5.4, 5.5 and 5.7)}
...
When the distribution is symmetric without outliers, use the \_\_\_\_\_\_\_\_\_\_\_\_ as the measure of center and the \_\_\_\_\_\_\_\_\_\_\_ as the measure of spread.

When the distribution is skewed or has outliers, use the \_\_\_\_\_\_\_\_\_\_\_\_\_ as the measure of center and the \_\_\_\_\_\_\_\_\_\_\_\_ as the measure of spread.

\setstretch{1}

\subsection*{Video: One Quantitative Variable - Plots (sections 5.2, 5.3 and 5.5)}\label{video-one-quantitative-variable---plots-sections-5.2-5.3-and-5.5}
\addcontentsline{toc}{subsection}{Video: One Quantitative Variable - Plots (sections 5.2, 5.3 and 5.5)}
...
\tightlist
\item
  Dotplot: each dot represents one \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
\end{itemize}

\rgi \rgi - x-axis represents the scale of the \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_

\rgi \rgi - y-axis represents the \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
...
\item
  ...
  \item
    The box starts at \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
  \item
    The line within the box is plotted at the \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
  \item
    The box ends at \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
  \item
    The whiskers extend to the lowest and highest \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ values in the dataset
  \item
    The dots beyond the whiskers represent \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_.
  \end{itemize}
\end{itemize}
...
\rgi values less than \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ are considered low outliers

\rgi values greater than \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ are considered high outliers

\subsubsection*{Optional notes: Additional Example}\label{optional-notes-additional-example-3}
\addcontentsline{toc}{subsubsection}{Optional notes: Additional Example}
...
\subsubsection*{Four characteristics of plots for quantitative variables}\label{four-characteristics-of-plots-for-quantitative-variables-1}
\addcontentsline{toc}{subsubsection}{Four characteristics of plots for quantitative variables}
...
\subsection*{Simulation-based Testing for One Quantitative Variable (section 17.2)}\label{simulation-based-testing-for-one-quantitative-variable-section-17.2}
\addcontentsline{toc}{subsection}{Simulation-based Testing for One Quantitative Variable (section 17.2)}
...
\tightlist
\item
  Direction of the alternative depends on the \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_.
\end{itemize}
...
\item
  ...
  \begin{itemize}
  \item
    Shift the data by the difference between \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
  \item
    Sample with replacement \_\_\_\_\_\_\_\_\_\_\_\_ times from the shifted data
  \item
    Plot the simulated shifted sample \_\_\_\_\_\_\_\_\_\_\_\_\_ from each simulation
  \item
    Repeat 10000 times (simulations) to create the \_\_\_\_\_\_\_\_\_\_\_\_ distribution
  \item
    Find the proportion of \_\_\_\_\_\_\_\_\_\_\_\_\_ \_\_\_\_\_\_\_\_\_\_\_\_\_\_ at least as extreme as \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
  \end{itemize}
\end{itemize}
...
\subsubsection*{Optional notes: Additional Example}\label{optional-notes-additional-example-4}
\addcontentsline{toc}{subsubsection}{Optional notes: Additional Example}
...
\subsection*{Bootstrap Confidence Intervals for One Quantitative Variable (section 17.1)}\label{bootstrap-confidence-intervals-for-one-quantitative-variable-section-17.1}
\addcontentsline{toc}{subsection}{Bootstrap Confidence Intervals for One Quantitative Variable (section 17.1)}

A confidence interval gives a range of plausible values for the \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ .
...
\begin{itemize}
\item
  Label cards with the values from the \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
\item
  Sample with replacement (bootstrap) from the original sample \_\_\_\_\_\_\_\_\_\_\_\_\_ times
\item
  Plot the simulated sample \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ from each simulation
\item
  Repeat at least 10000 times (simulations) to create the \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ distribution
\item
  Find the cut-offs for the middle X\% (confidence level) in a bootstrap distribution.
\end{itemize}
...
\subsubsection*{Optional notes: Additional Example}\label{optional-notes-additional-example-5}
\addcontentsline{toc}{subsubsection}{Optional notes: Additional Example}
...
\FunctionTok{one\_mean\_CI}\NormalTok{(pb}\SpecialCharTok{$}\NormalTok{Weight,}
  ...
  \AttributeTok{number\_repetitions =} \DecValTok{10000}\NormalTok{,}
  \AttributeTok{confidence\_level =} \FloatTok{0.90}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\section{Activity 10: Summarizing Quantitative Variables}\label{activity-10-summarizing-quantitative-variables}
...
The \texttt{favstats()} function from the \texttt{mosaic} package gives the summary statistics for a quantitative variable. The R output below provides the summary statistics for the variable \texttt{Cost\_InState}. The summary statistics provided are the two measures of center (mean and median) and two measures of spread (standard deviation and the quartile values to calculate the IQR) for undergraduate In-State tuition cost.
...
\NormalTok{IPEDS }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{summarize}\NormalTok{(}\FunctionTok{favstats}\NormalTok{(Cost\_InState))}
\end{Highlighting}
\end{Shaded}
...
First, let's create a histogram of the variable \texttt{Cost\_InState}.

\begin{itemize}
\item
  Enter the name of the variable, \texttt{Cost\_InState} in line 19 for \texttt{variable} in the R script file.
\item
...
\FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Cost\_InState)) }\SpecialCharTok{+}   \CommentTok{\# Name variable to plot}
  \FunctionTok{geom\_histogram}\NormalTok{(}\AttributeTok{binwidth =} \DecValTok{10000}\NormalTok{, }\AttributeTok{boundary =} \DecValTok{0}\NormalTok{, }\AttributeTok{closed =} \StringTok{"left"}\NormalTok{) }\SpecialCharTok{+}  
    \CommentTok{\# Create histogram with specified binwidth}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"Don\textquotesingle{}t forget to title the plot!"}\NormalTok{, }\CommentTok{\# Title for plot}
       \AttributeTok{x =} \StringTok{"In{-}State Tuition Cost ($)"}\NormalTok{, }\CommentTok{\# Label for x axis}
       \AttributeTok{y =} \StringTok{"Frequency"}\NormalTok{) }\CommentTok{\# Label for y axis}
\end{Highlighting}
\end{Shaded}
...
Notice that the \textbf{bin width} for the histogram is 10000. For example the first bin consists of the number of institutions in the data set with an In-State cost of tuition of \$0 to \$10,000. It is important to note that a tuition cost on the boundary of a bin will fall into the bin above it; for example, 10000 would be counted in the bin 10000--20000.

\textbf{Which range of In-State Tuition Costs have the highest frequency?}

\vspace{0.4in}

Next we will create a boxplot of the variable \texttt{Cost\_InState}.
...
\FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Cost\_InState)) }\SpecialCharTok{+}   \CommentTok{\# Name variable to plot}
  ...
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"Boxplot of In{-}State Tuition Cost for 4{-}year }\SpecialCharTok{\textbackslash{}n}\StringTok{ Higher Education US Institutions"}\NormalTok{, }
...
\tightlist
\item
  What is the shape of the distribution of In-State tuition cost?
\end{enumerate}
...
\NormalTok{IPEDS }\SpecialCharTok{\%\textgreater{}\%} \CommentTok{\# Data set piped into...}
    ...
    \FunctionTok{geom\_boxplot}\NormalTok{() }\SpecialCharTok{+} \CommentTok{\# Create boxplot }
    \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"Boxplot of Retention Rates for }\SpecialCharTok{\textbackslash{}n}\StringTok{ 4{-}year US Higher Education Institutions"}\NormalTok{,}
           \CommentTok{\# Title for plot}
...
\NormalTok{IPEDS }\SpecialCharTok{\%\textgreater{}\%} \CommentTok{\# Data set piped into...}
    ...
    \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"Boxplot of Increased Retention Rates for }\SpecialCharTok{\textbackslash{}n}\StringTok{ 4{-}year US Higher Education Institutions"}\NormalTok{, }
        \CommentTok{\# Title for plot}
        \AttributeTok{x =} \StringTok{"Retention Rate (\%)"}\NormalTok{, }\CommentTok{\# Label for x axis}
        \AttributeTok{y =} \StringTok{""}\NormalTok{) }\SpecialCharTok{+} \CommentTok{\# Remove y axis label}
        \FunctionTok{theme}\NormalTok{(}\AttributeTok{axis.text.y =} \FunctionTok{element\_blank}\NormalTok{(), }
...
\section{Activity 11: Inference for a Single Quantitative Variable: Simulation Methods}\label{activity-11-inference-for-a-single-quantitative-variable-simulation-methods}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bodytemp }\OtherTok{\textless{}{-}} \FunctionTok{read.csv}\NormalTok{(}\StringTok{"datasetname.csv"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\newpage

\subsubsection*{Hypothesis Testing for a Single Mean}\label{hypothesis-testing-for-a-single-mean-1}
\addcontentsline{toc}{subsubsection}{Hypothesis Testing for a Single Mean}
...
\begin{itemize}
\item
  Enter the variable name, \texttt{Temp}, for \texttt{variable} in line 13
\item
...
\tightlist
\item
  About how far is each body temperature for a STAT 216 undergraduate from the mean body temperature, on average? Report the value and the appropriate notation
\end{enumerate}

\vspace{0.3in}

Create a boxplot of the variable \texttt{Temp}.
...
\NormalTok{bodytemp }\SpecialCharTok{\%\textgreater{}\%}
  ...
  \FunctionTok{geom\_boxplot}\NormalTok{()}\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title=}\StringTok{"Be sure to include a title!"}\NormalTok{,}
       \AttributeTok{x =} \StringTok{"body temperature (*F)"}\NormalTok{, }\CommentTok{\# Label for x axis}
       \AttributeTok{y =} \StringTok{""}\NormalTok{) }\SpecialCharTok{+} \CommentTok{\# Remove y axis label}
        \FunctionTok{theme}\NormalTok{(}\AttributeTok{axis.text.y =} \FunctionTok{element\_blank}\NormalTok{(), }
          \AttributeTok{axis.ticks.y =} \FunctionTok{element\_blank}\NormalTok{()) }\CommentTok{\# Removes y{-}axis ticks}
\end{Highlighting}
...
\tightlist
\item
  Describe the distribution of body temperature using the four characteristics of boxplots.
\end{enumerate}

\vspace{1in}

\subsection*{Simulation methods}\label{simulation-methods-2}
\addcontentsline{toc}{subsection}{Simulation methods}
...
To simulate the null distribution of sample means we will use a bootstrapping method. Recall that the null distribution must be created under the assumption that the null hypothesis is true. Therefore, before bootstrapping, we will need to \emph{shift} each data point by the difference \(\mu_0 - \bar{y}\). This will ensure that the mean of the shifted data is \(\mu_0\) (rather than the mean of the original data, \(\bar{y}\)), and that the simulated null distribution will be centered at the null value.
...
\item
  In the column, Shift, add the shifted value to each value in the \texttt{Temp} column.
\end{itemize}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bodytemp }\OtherTok{\textless{}{-}} \FunctionTok{read.csv}\NormalTok{(}\StringTok{"normal\_temperature.csv"}\NormalTok{)}
\NormalTok{bodytemp }\SpecialCharTok{\%\textgreater{}\%}
...
\tightlist
\item
  Report the standard deviation of the \texttt{Shift} variable. How does this compare to the standard deviation for the variable \texttt{Temp}? Explain why these values are the same.
\end{enumerate}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{one\_mean\_test}\NormalTok{(bodytemp}\SpecialCharTok{$}\NormalTok{Temp,}\CommentTok{\#Enter the object name and variable}
              \AttributeTok{null\_value =} \FloatTok{98.6}\NormalTok{,}
              \AttributeTok{summary\_measure =} \StringTok{"mean"}\NormalTok{,  }\CommentTok{\#Can choose between mean or median}
              \AttributeTok{shift =} \FloatTok{0.3154}\NormalTok{, }\CommentTok{\#Difference between the null value and the sample mean}
              \AttributeTok{as\_extreme\_as =} \FloatTok{98.2846}\NormalTok{, }\CommentTok{\#Value of the summary statistic}
              \AttributeTok{direction =} \StringTok{"two{-}sided"}\NormalTok{, }\CommentTok{\#Specify direction of alternative hypothesis}
              \AttributeTok{number\_repetitions =} \DecValTok{10000}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{one\_mean\_CI}\NormalTok{(bodytemp}\SpecialCharTok{$}\NormalTok{Temp, }\CommentTok{\#Enter the name of the variable}
            \AttributeTok{summary\_measure =} \StringTok{"mean"}\NormalTok{, }\CommentTok{\#choose the mean or median}
            \AttributeTok{number\_repetitions =} \DecValTok{10000}\NormalTok{,  }\CommentTok{\# Number of simulations}
...
\item
  As in the one proportion scenario, we calculate the p-value for a simulation-based hypothesis test for a single mean by finding the proportion of simulated sample means that are as or more extreme (in the direction of \(H_A\)) as the observed sample mean, \(\bar{y}\).
\end{enumerate}
...
\item
  \textbf{Conditions for the sampling distribution of \(\bar{y}\) to follow an approximate normal distribution}:
...
\item
  ...
  \[ME = t^* \times SE(\bar{y})\]
  where \(t^*\) is the \textbf{multiplier}, corresponding to the desired confidence level found from a \(t\)-distribution with \(n-1\) degrees of freedom and \[SE(\bar{y}) = \frac{s}{\sqrt{n}}.\]
\item
...
\begin{itemize}
\item
  Theoretical\_Tests\_One\_Quantitative\_Variable
\item
  Theoretical\_Intervals\_One\_Quantitative\_Variable
\item
  Errors\_Power
\end{itemize}
...
\subsection*{Theory-based Test for One Quantitative Variable (sections 17.3.1, 17.3.2 and 17.3.4)}\label{theory-based-test-for-one-quantitative-variable-sections-17.3.1-17.3.2-and-17.3.4}
\addcontentsline{toc}{subsection}{Theory-based Test for One Quantitative Variable (sections 17.3.1, 17.3.2 and 17.3.4)}
...
\begin{itemize}
\item
  Estimate the population standard deviation, \(\sigma\), with the \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ standard deviation, \_\_\_\_\_\_\_\_.
\item
  For a single quantitative variable we use the \_\_\_\_ - distribution with \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
...
\subsubsection*{Optional notes: Additional Example}\label{optional-notes-additional-example-6}
\addcontentsline{toc}{subsubsection}{Optional notes: Additional Example}
...
\subsection*{Theory-based Confidence Interval for One Quantitative Variable (section 17.3.3)}\label{theory-based-confidence-interval-for-one-quantitative-variable-section-17.3.3}
\addcontentsline{toc}{subsection}{Theory-based Confidence Interval for One Quantitative Variable (section 17.3.3)}

\setstretch{1.5}

Confidence intervals are used to estimate the \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_.
...
\begin{itemize}
\item
  \(\text{statistic}\) = \_\_\_\_\_\_\_\_\_\_\_
\item
  \(\text{margin of error} = \text{multiplier} \times \text{standard error of the statistic}=\) \_\_\_\_\_\_\_\_\_\_\_\_ \(\times\) \_\_\_\_\_\_\_\_\_\_\_\_\_\_
\end{itemize}
...
\subsubsection*{Optional notes: Additional Example}\label{optional-notes-additional-example-7}
\addcontentsline{toc}{subsubsection}{Optional notes: Additional Example}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{qt}\NormalTok{(}\FloatTok{0.95}\NormalTok{, }\AttributeTok{df =} \DecValTok{82}\NormalTok{)}
\CommentTok{\#\textgreater{} [1] 1.663649}
\end{Highlighting}
\end{Shaded}
...
\section{Activity 12: Inference for a Single Quantitative Variable: Theory-based Methods}\label{activity-12-inference-for-a-single-quantitative-variable-theory-based-methods}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sleep }\OtherTok{\textless{}{-}} \FunctionTok{read.csv}\NormalTok{(}\StringTok{"https://www.math.montana.edu/courses/s216/data/sleep\_college.csv"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{sleep }\SpecialCharTok{\%\textgreater{}\%} \CommentTok{\# Data set piped into...}
    \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ SleepHours)) }\SpecialCharTok{+}   \CommentTok{\# Name variable to plot}
    \FunctionTok{geom\_boxplot}\NormalTok{() }\SpecialCharTok{+}  \CommentTok{\# Create boxplot with specified binwidth}
    \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"Boxplot of Number of Hours of Sleep for MSU Students"}\NormalTok{, }\CommentTok{\# Title for plot}
...
\tightlist
\item
  Highlight and run lines 20--21 to get the summary statistics for the variable \texttt{SleepHours}.
\end{itemize}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sleep }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{summarise}\NormalTok{(}\FunctionTok{favstats}\NormalTok{(SleepHours))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{qt}\NormalTok{(}\FloatTok{0.975}\NormalTok{, }\AttributeTok{df =} \DecValTok{122}\NormalTok{, }\AttributeTok{lower.tail=}\ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\item
  In order to find a theory-based p-value, we use R to calculate the area under a \(t\)-distribution with \(n - 1\) degrees of freedom (df) that is at or more extreme than the observed \(T\)-score.
\item
...
\section{Activity 13: Errors and Power}\label{activity-13-errors-and-power}
...
\setcounter{enumi}{5}
\item
  What is the value of \(\bar{y}\)? What is the sample size?
  \vspace{0.25in}
\item
...
\tightlist
\item
  Do you expect the 90\% confidence interval to contain the null value of 0.150? Explain.
\end{enumerate}
...
\item
  Study\_Design
\item
  Two\_Categorical\_Variables\_Statistics
\item
  Two\_Categorical\_Variables\_Plots
\item
  Simulation\_Tests\_Two\_Categorical\_Variables
\item
  Bootstrap\_Intervals\_Two\_Categorical\_Variables
\item
  Relative\_Risk
\end{itemize}

\subsection*{Video: Variable Roles (sections 1.2.3 and 1.2.4)}\label{video-variable-roles-sections-1.2.3-and-1.2.4}
\addcontentsline{toc}{subsection}{Video: Variable Roles (sections 1.2.3 and 1.2.4)}
...
\begin{itemize}
\item
  The variable researchers think \emph{may be} \_\_\_\_\_\_\_\_\_\_\_\_\_ the other variable.
\item
...
\subsection*{Video: Study Design (sections 1.2.5, 2.2, 2.3 and 2.4)}\label{video-study-design-sections-1.2.5-2.2-2.3-and-2.4}
\addcontentsline{toc}{subsection}{Video: Study Design (sections 1.2.5, 2.2, 2.3 and 2.4)}

\subsubsection*{Confounding variables}\label{confounding-variables}
\addcontentsline{toc}{subsubsection}{Confounding variables}
...
\begin{itemize}
\item
  associated with both the \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ and the \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ variable
\item
...
From the study, can we determine that more sunscreen use \emph{causes} skin cancer?
...
\subsubsection*{Optional Notes: Additional Example(s)}\label{optional-notes-additional-examples-1}
\addcontentsline{toc}{subsubsection}{Optional Notes: Additional Example(s)}
...
Example: In the Physician's Health Study (\emph{Physician's Health Study}, n.d.), male physicians participated in a study to determine whether taking a daily low-dose aspirin reduced the risk of heart attacks. The male physicians were randomly assigned to the treatment groups. After five years, 104 of the 11,037 male physicians taking a daily low-dose aspirin had experienced a heart attack while 189 of the 11,034 male physicians taking a placebo had experienced a heart attack.
...
\subsection*{Video: Two Categorical Variables - Statistics (section 4.1)}\label{video-two-categorical-variables---statistics-section-4.1}
\addcontentsline{toc}{subsection}{Video: Two Categorical Variables - Statistics (section 4.1)}
...
\tightlist
\item
  Do the variables \texttt{number} and \texttt{spam} appear to be associated? How can you tell?
\end{itemize}

\vspace{0.5in}

\subsubsection*{Optional notes: Additional Example}\label{optional-notes-additional-example-8}
\addcontentsline{toc}{subsubsection}{Optional notes: Additional Example}
...
\subsection*{Video: Two Categorical Variables - Plots (section 4.2)}\label{video-two-categorical-variables---plots-section-4.2}
\addcontentsline{toc}{subsection}{Video: Two Categorical Variables - Plots (section 4.2)}
...
\rgi \rgi - \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ variable will be represented by the bars

\rgi \rgi - \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ variable will be represented by the segments

\rgi \rgi - The segments within the bar will add to \_\_\_\_\_\_\_\_\_ (meaning the y-axis scale will be from 0 to \_\_\_\_\_\_\_\_\_\_\_)

\begin{itemize}
\tightlist
\item
  Mosaic plot: Same as the segmented bar plot but the width of the bar is determined by \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
\end{itemize}
...
\subsubsection*{Optional notes: Additional Example}\label{optional-notes-additional-example-9}
\addcontentsline{toc}{subsubsection}{Optional notes: Additional Example}

Using the same Gallatin County home sales data, we can plot the \texttt{From} and \texttt{Age\_Group} variables discussed in the previous video.
...
\subsection*{Video: Simpson's paradox (section 4.4)}\label{video-simpsons-paradox-section-4.4}
\addcontentsline{toc}{subsection}{Video: Simpson's paradox (section 4.4)}
...
\tightlist
\item
  When an apparent association between \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ and \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ variables reverses when accounting for a \_\_\_\_\_\_\_\_\_\_\_\_\_\_ variable.
\end{itemize}
...
\subsection*{Video: Simulation Testing for Two Categorical Variables (section 15.1)}\label{video-simulation-testing-for-two-categorical-variables-section-15.1}
\addcontentsline{toc}{subsection}{Video: Simulation Testing for Two Categorical Variables (section 15.1)}
...
\item
  The \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ variable will determine the two groups being compared.
\item
  A ``success'' will be the level of the \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ variable being compared between the two groups.
\end{itemize}
...
\item
  ...
  \begin{itemize}
  \item
    Write the \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ variable on cards
  \item
    Mix the \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ variable groups together
  \item
    Shuffle cards into two ``new'' \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ variable groups, the sample sizes of the original groups (\(n_1\) and \(n_2\))
  \item
    Calculate and plot the simulated \_\_\_\_\_\_\_\_\_\_\_\_ \_\_\_\_\_ \_\_\_\_\_\_\_\_\_\_\_ \_\_\_\_\_\_\_\_\_\_\_\_ from each simulation
  \item
    Repeat 10000 times (simulations) to create the \_\_\_\_\_\_\_\_\_\_\_\_ distribution
  \item
    Find the proportion of \_\_\_\_\_\_\_\_\_\_\_\_\_ at least as extreme as \_\_\_\_\_\_\_\_\_\_\_\_\_
  \end{itemize}
\end{itemize}

\setstretch{1}

\subsubsection*{Optional Notes: Additional Example}\label{optional-notes-additional-example-10}
\addcontentsline{toc}{subsubsection}{Optional Notes: Additional Example}
...
\subsection*{Video: Bootstrap Confidence Interval for Two Categorical Variables (section 15.2)}\label{video-bootstrap-confidence-interval-for-two-categorical-variables-section-15.2}
\addcontentsline{toc}{subsection}{Video: Bootstrap Confidence Interval for Two Categorical Variables (section 15.2)}
...
\item
  Keep explanatory variable groups \_\_\_\_\_\_\_\_\_\_\_\_\_\_
\item
  Sample with replacement \_\_\_\_\_\_\_\_\_\_ times in explanatory variable group 1 and \_\_\_\_\_\_\_\_ times in explanatory variable group 2
\item
  Calculate and plot the simulated \_\_\_\_\_\_\_\_\_\_\_\_ \_\_\_\_\_ \_\_\_\_\_\_\_\_\_\_\_ \_\_\_\_\_\_\_\_\_\_\_\_ from each simulation
\item
  Repeat 10000 times (simulations) to create the \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ distribution
\item
  Find the cut-offs for the middle X\% (confidence level) in a bootstrap distribution.
\end{itemize}
...
\subsubsection*{Optional Notes: Additional Example}\label{optional-notes-additional-example-11}
\addcontentsline{toc}{subsubsection}{Optional Notes: Additional Example}
...
\subsection*{Video: Relative Risk (section 15.1.3)}\label{video-relative-risk-section-15.1.3}
\addcontentsline{toc}{subsection}{Video: Relative Risk (section 15.1.3)}
...
\tightlist
\item
  Relative risk is the \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ of the risk of ``success'' comparing two groups.
\end{itemize}
...
\begin{itemize}
\item
  Compare the risk of group 1 to group 2: The risk of \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ is group 1 is \_\_\_\_\_\_\_\_ times the risk of \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ in group 2.
\item
  Discuss an increase/decrease in risk: The risk of \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ is group 1 is \_\_\_\_\_\_\_\_ times \textbf{higher/lower} than the risk of \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ in group 2.
\item
  Discuss an \emph{percent} increase/decrease in risk: The risk of \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ is group 1 is \_\_\_\_\_\_\_\_ \% \textbf{higher/lower} than the risk of \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ in group 2.
\end{itemize}
...
\subsubsection*{Optional Notes: Additional Example}\label{optional-notes-additional-example-12}
\addcontentsline{toc}{subsubsection}{Optional Notes: Additional Example}
...
\tightlist
\item
  Find the \emph{percent} increase (or decrease) in risk of desensitization and interpret this value in context of the problem.
\end{itemize}

\vspace{0.8in}

\subsubsection*{Optional Notes: Additional Example}\label{optional-notes-additional-example-13}
\addcontentsline{toc}{subsubsection}{Optional Notes: Additional Example}
...
\section{Activity 14: Study Design}\label{activity-14-study-design}
...
\section{Activity 15: Summarizing Two Categorical Variables}\label{activity-15-summarizing-two-categorical-variables}
...
\StringTok{       Myopia for Children"}\NormalTok{,  }
       ...
       \AttributeTok{fill =} \StringTok{"Level of Myopia"}\NormalTok{)  }\SpecialCharTok{+}  \CommentTok{\# Fill label}
...
\NormalTok{myopia }\SpecialCharTok{\%\textgreater{}\%} \CommentTok{\# Data set piped into...}
  \FunctionTok{ggplot}\NormalTok{() }\SpecialCharTok{+}   \CommentTok{\# This specifies the variables}
  \FunctionTok{geom\_mosaic}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\FunctionTok{product}\NormalTok{(Sight, Light), }\AttributeTok{fill =}\NormalTok{ Sight)) }\SpecialCharTok{+}  \CommentTok{\# Tell it to make a mosaic plot}
...
\StringTok{       Myopia for Children"}\NormalTok{,  }\CommentTok{\# Make sure to title your plot }
       \AttributeTok{x =} \StringTok{"Level of Light"}\NormalTok{, }\AttributeTok{y =} \StringTok{""}\NormalTok{,}
       \AttributeTok{fill =} \StringTok{"Level of Myopia"}\NormalTok{)  }\SpecialCharTok{+}  \CommentTok{\# Fill label}
...
\section{Activity 16: The Good Samaritan}\label{activity-16-the-good-samaritan}
...
\NormalTok{good }\SpecialCharTok{\%\textgreater{}\%}
  ...
  \FunctionTok{geom\_bar}\NormalTok{(}\AttributeTok{stat =} \StringTok{"count"}\NormalTok{, }\AttributeTok{position =} \StringTok{"fill"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"Segmented Bar Plot of Whether Princeton Seminary}
\StringTok{  Students Help the Actor between those that were in a }
\StringTok{  Hurry and those that were Not in a Hurry"}\NormalTok{,  }\CommentTok{\#Title your plot}
       \AttributeTok{y =} \StringTok{"Relative Frequency"}\NormalTok{, }\CommentTok{\#y{-}axis label}
       \AttributeTok{x =} \StringTok{"Whether student was in a hurry"}\NormalTok{, }\CommentTok{\#x{-}axis label}
       \AttributeTok{fill =} \StringTok{"Whether student helped the Actor"}\NormalTok{) }\SpecialCharTok{+} \CommentTok{\#Fill label}
  \FunctionTok{scale\_fill\_grey}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{itemize}
\item
  Theoretical\_Tests\_Two\_Categorical\_Variables
\item
  Theoretical\_Intervals\_Two\_Categorical\_Variables
\end{itemize}

\setstretch{1}

\subsection*{Video: Theoretical Testing for Two Categorical Variables (sections 15.3.1 and 15.3.3)}\label{video-theoretical-testing-for-two-categorical-variables-sections-15.3.1-and-15.3.3}
\addcontentsline{toc}{subsection}{Video: Theoretical Testing for Two Categorical Variables (sections 15.3.1 and 15.3.3)}
...
\tightlist
\item
  This value measures how far each possible \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ is from the \_\_\_\_\_\_\_\_\_\_, on average.
\end{itemize}
...
\tightlist
\item
  This value measures how many \_\_\_\_\_\_\_\_\_\_\_ \_\_\_\_\_\_\_\_\_\_\_\_\_ the observed difference in sample proportions is above/below the \_\_\_\_\_\_\_\_\_\_ \_\_\_\_\_\_\_\_\_\_\_.
\end{itemize}

\setstretch{1}

\subsubsection*{Optional Notes: Additional Example}\label{optional-notes-additional-example-14}
\addcontentsline{toc}{subsubsection}{Optional Notes: Additional Example}

Example: Earlier in the semester, we investigated data on higher education institutions in the United States, collected by the Integrated Postsecondary Education Data System (IPEDS) for the National Center for Education Statistics (NCES) (Education Statistics 2018). A random sample of 2900+ higher education institutions in the United States was collected in 2018. Two variables measured on this data set is whether the institution is a land grant university and whether the institution offers tenure. Does the proportion of universities that offer tenure differ between land grant and non-land-grant institutions? Use land grant - non-land-grant as the order of subtraction.
...
\subsection*{Theoretical Confidence Interval for Two Categorical Variables (section 15.3.2)}\label{theoretical-confidence-interval-for-two-categorical-variables-section-15.3.2}
\addcontentsline{toc}{subsection}{Theoretical Confidence Interval for Two Categorical Variables (section 15.3.2)}
...
\begin{itemize}
\item
  \(\text{statistic}\) = \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
\item
  \(\text{margin of error} = \text{multiplier} \times \text{standard error of the statistic}=\) \_\_\_\_\_\_\_\_\_\_\_\_ \(\times\) \_\_\_\_\_\_\_\_\_\_\_\_\_\_
\end{itemize}
...
\tightlist
\item
  Because we no longer assume the \_\_\_\_\_\_\_\_\_\_\_\_\_ hypothesis is true, we need to keep the two groups \emph{separate}. Use the sample proportions in group 1 and in group 2 to calculate the sample to sample variability, rather than \(\hat{p}_{pooled}\).
\end{itemize}
...
\tightlist
\item
  1st, use \texttt{R} find the \(z^*\) multiplier
\end{itemize}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{qnorm}\NormalTok{(}\FloatTok{0.995}\NormalTok{, }\AttributeTok{lower.tail=}\ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\section{Activity 17: Winter Sports Helmet Use and Head Injuries --- Theory-based Methods}\label{activity-17-winter-sports-helmet-use-and-head-injuries-theory-based-methods}
...
\StringTok{       Helmet Use Groups"}\NormalTok{,  }\CommentTok{\# Make sure to title your plot}
       \AttributeTok{x =} \StringTok{"whether wore helmet"}\NormalTok{,   }\CommentTok{\# Label the x axis}
       \AttributeTok{y =} \StringTok{""}\NormalTok{,  }\CommentTok{\# Remove y axis label}
       \AttributeTok{fill =} \StringTok{"whether had a head injury"}\NormalTok{) }\SpecialCharTok{+} \CommentTok{\# Fill label}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mushrooms }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{group\_by}\NormalTok{(explanatory) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{count}\NormalTok{(response) }\CommentTok{\#finds the counts in each group}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mushrooms }\SpecialCharTok{\%\textgreater{}\%} \CommentTok{\# Data set piped into...}
  ...
  \FunctionTok{geom\_bar}\NormalTok{(}\AttributeTok{stat =} \StringTok{"count"}\NormalTok{, }\AttributeTok{position =} \StringTok{"fill"}\NormalTok{) }\SpecialCharTok{+}  \CommentTok{\# Tell it to make a stacked bar plot}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"Don\textquotesingle{}t forget a title!"}\NormalTok{,  }\CommentTok{\# Make sure to title your plot}
       \AttributeTok{x =} \StringTok{"Add x{-}axis label"}\NormalTok{,   }\CommentTok{\# Label the x axis}
       \AttributeTok{y =} \StringTok{""}\NormalTok{, }\CommentTok{\# Remove y axis label}
       \AttributeTok{fill =} \StringTok{"Add fill label"}\NormalTok{) }\SpecialCharTok{+}  \CommentTok{\# Fill label}
  \FunctionTok{scale\_fill\_grey}\NormalTok{()  }\CommentTok{\# Make figure black and white}
\end{Highlighting}
\end{Shaded}
...
\tightlist
\item
  Calculate the difference \(\mu_0 - \bar{y}\). Will we need to shift the data up or down?
  \vspace{0.5in}
\end{enumerate}
...
\subsubsection*{Errors and Power}\label{errors-and-power}
\addcontentsline{toc}{subsubsection}{Errors and Power}
...
\section{Module 8 Review}\label{module-8-review}
...
\item
  ...
  \vspace{0.7in}
\item
  Regardless to your answer in part h, calculate the standardized statistic.
  \vspace{0.4in}
\item
  Interpret the value of the standardized statistic in context of the problem.
  \vspace{0.7in}
