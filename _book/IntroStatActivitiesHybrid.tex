...
\chapter{Inference for Two Categorical Variables: Theory-based Hypothesis Testing and Simulation-based and Theory-based Confidence Intervals}\label{inference-for-two-categorical-variables-theory-based-hypothesis-testing-and-simulation-based-and-theory-based-confidence-intervals}
...
\item
  ...
  \item
    Use the \texttt{pnorm} function in R to find a theory-based p-value for a hypothesis test involving a difference in proportions.
  \end{itemize}
\item
