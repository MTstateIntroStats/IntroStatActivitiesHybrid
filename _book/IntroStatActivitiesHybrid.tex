...
\chapter{Inference for a Single Quantitative Variable}\label{inference-for-a-single-quantitative-variable-1}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{one\_mean\_test}\NormalTok{(object}\SpecialCharTok{$}\NormalTok{variable,   }\CommentTok{\# Vector of differences }
