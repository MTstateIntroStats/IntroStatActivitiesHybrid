...
* First calculate the $SE(\bar{y}_1 - \bar{y}_2)$
...
\begin{center}\includegraphics[width=0.6\linewidth]{11-VN11-1ofeach_files/figure-latex/unnamed-chunk-9-1} \end{center}
...
* Simulate many samples assuming $H_0: \mu_1 = \mu_2$
    ...
    * Find the proportion of simulations at least as extreme as $\bar{y}_1 - \bar{y}_2$
...
\begin{center}\includegraphics[width=0.7\linewidth]{11-VN11-1ofeach_files/figure-latex/unnamed-chunk-10-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{11-VN11-1ofeach_files/figure-latex/unnamed-chunk-11-1} \end{center}
