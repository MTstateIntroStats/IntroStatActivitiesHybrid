## Activity 16:  The Good Samaritan 
...
good %>%
  ...
  labs(title = "Segmented Bar Plot of Whether Princeton Seminary
  Students Help the Actor between those that were in a 
  Hurry and those that were Not in a Hurry",  #Title your plot
       y = "Relative Frequency", #y-axis label
       x = "Whether student was in a hurry", #x-axis label
       fill = "Whether student helped the Actor") + #Fill label
  scale_fill_grey()
```



\begin{center}\includegraphics[width=0.7\linewidth]{08-A16-inference-2cat-simulation_files/figure-latex/TRUE-1} \end{center}
...
\begin{center}\includegraphics[width=0.6\linewidth]{08-A16-inference-2cat-simulation_files/figure-latex/unnamed-chunk-4-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{08-A16-inference-2cat-simulation_files/figure-latex/unnamed-chunk-5-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{08-A16-inference-2cat-simulation_files/figure-latex/unnamed-chunk-6-1} \end{center}
