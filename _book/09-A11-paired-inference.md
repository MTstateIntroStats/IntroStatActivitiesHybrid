...
* Upload and open the R script file for this activity. 

* Upload the csv file, `pain_tolerance`. 
...
10.  Simulate a null distribution and compute the p-value. Using the R script file for this lab, enter your answers for question 9 in place of the `xx`'s to produce the null distribution with 1000 simulations.  Highlight and run lines 30--36.  
...
13. Using bootstrapping and the provided R script file, find a 98\% confidence interval. Fill in the missing values/numbers in the `paired_bootstrap_CI()` function to create the 98\% confidence interval.  Highlight and run lines 41--44. 
...
14. Interpret the *confidence level* of the interval found in question 13. 
