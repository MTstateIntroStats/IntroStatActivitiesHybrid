...
\begin{center}\includegraphics[width=0.7\linewidth]{06-A11-inference-quantitative_simulation_files/figure-latex/unnamed-chunk-6-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{06-A11-inference-quantitative_simulation_files/figure-latex/unnamed-chunk-7-1} \end{center}
...
Activities 10--11 cover the material in Module 6.  For more practice with Simulation confidence intervals for a single quantitative variable use the Module 6 Review worksheet in the Unit 2 Review Materials (pgs. 248--250).
