...
\begin{center}\includegraphics[width=0.6\linewidth]{13-A23-EDA-two-quantitative-corr_files/figure-latex/unnamed-chunk-1-1} \end{center}
...
Later in this activity, we will explore more about what the coefficient of determination measures.

7.  Use the correlation, $r$, found in the correlation matrix, to calculate the coefficient of determination between bill depth and body mass, $r^2$, for Antarctica penguins.

\vspace{.4in}

8.  The coefficient of determination between bill depth and flipper length is 33.5\%.  Calculate the correlation between these variables from this value. How can we tell if the value of correlation should be positive or negative?
...
\begin{center}\includegraphics[width=0.7\linewidth]{13-A23-EDA-two-quantitative-corr_files/figure-latex/unnamed-chunk-4-1} \end{center}
...
#### Coefficient of determination (revisited) {-}

We will now revisit the coefficient of determination for the relationship between bill depth and body mass for just the Genetoo species.  As a reminder, these are the formulas used to calculate the coefficient of determination: 
...
\begin{center}\includegraphics[width=0.7\linewidth]{13-A23-EDA-two-quantitative-corr_files/figure-latex/unnamed-chunk-5-1} \end{center}
...
```
9.  Use the correlation, $r$, found in the correlation matrix, to calculate the coefficient of determination between bill depth and body mass, $r^2$, for the Gentoo species.

\vspace{.4in}

The variance of the response variable, body mass (g), is $s_{\text{body mass}}^2 = 249759.1$ $g^2$, the variance of the explanatory variable, bill depth (mm), is $s_{\text{bill depth}}^2 = 0.968145$ $mm^2$, and the variance in the residuals is $s_{RES}^2 = 120907.1$ $g^2$.  Use these values to calculate the coefficient of determination.
...
\begin{center}\includegraphics[width=0.7\linewidth]{13-A23-EDA-two-quantitative-corr_files/figure-latex/unnamed-chunk-8-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{13-A23-EDA-two-quantitative-corr_files/figure-latex/unnamed-chunk-10-1} \end{center}
