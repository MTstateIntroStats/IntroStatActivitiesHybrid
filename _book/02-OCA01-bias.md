...
4. Based on the plot and summary statistics of sample mean word lengths above, what is your best guess for the average word length of the population of all 359 words in the speech? 
\vspace{0.3in}
...
7.  Using the graph created above, estimate the proportion of students' computed sample means that were lower than the true mean of 3.95 letters? 
\vspace{0.5in}
