...
For more practice on types of bias, as well as identifying the observational units and variable(s) in a study, use the Module 1 Review worksheet in the Unit 1 Review Materials (pgs.101--102).
