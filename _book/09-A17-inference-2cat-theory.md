## Activity 17:  Winter Sports Helmet Use and Head Injuries --- Theory-based Methods
...
* Highlight and run 1--14 to import the data set and create the segmented bar plot
...
skiers %>% # Data set piped into...
  ...
  labs(title = "Segmented Bar Plot of Head Injuries for Skiers and 
       ...
       Helmet Use Groups",  # Make sure to title your plot
       x = "whether wore helmet",   # Label the x axis
       y = "",  # Remove y axis label
       fill = "whether had a head injury") + # Fill label
  scale_fill_grey()  # Make figure black and white
```



\begin{center}\includegraphics[width=0.6\linewidth]{09-A17-inference-2cat-theory_files/figure-latex/unnamed-chunk-1-1} \end{center}
...
\begin{center}\includegraphics[width=0.5\linewidth]{09-A17-inference-2cat-theory_files/figure-latex/simpleNormal-1} \end{center}
