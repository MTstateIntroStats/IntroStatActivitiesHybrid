## Activity 20:  Paired vs. Independent Samples
...
\begin{center}\includegraphics[width=0.7\linewidth]{12-A20-EDA-paired_files/figure-latex/unnamed-chunk-1-1} \end{center}
...
tat_diff %>% 
    ...
    geom_boxplot()+
    labs(title="Boxplot of the difference in Sweat Rate (mg per (cm^2*min))
         for Adult Men with Tattoos comparing 
...
\begin{center}\includegraphics[width=0.65\linewidth]{12-A20-EDA-paired_files/figure-latex/unnamed-chunk-2-1} \end{center}
