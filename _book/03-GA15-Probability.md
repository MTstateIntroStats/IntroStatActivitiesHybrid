...
\vspace{.8in}
   ...
   d. Find the probability that a deer that is positive for CWD will not survive. What is the notation used for this probability?
\vspace{.8in}
