...
Using the R script file for this activity, enter your answers for question 9 in place of the `xx`'s to produce the bootstrap distribution with 10000 simulations; highlight and run lines 35--39.
