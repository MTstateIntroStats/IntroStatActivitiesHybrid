...
In the out of class activity, the code was provided to import the data set needed directly from the Stat 216 website.  Follow these steps to upload and import the data set for today's lab.
...
To assess the research question described before question 13, enter the name of the explanatory variable and the name of the response variable in lines 51 and 54 of the R script file.  Remember that the variable name must be typed in EXACTLY as it is written in the data set. Highlight and run lines 50 -- 58 to find the summary statistics and create side by side boxplots of the data.
...
18. Does there appear to be an association between sector and size of 4-year institutions? Explain your answer using the plot.
