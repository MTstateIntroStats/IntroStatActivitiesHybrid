## Activity 18:  Does behavior impact performance?
...
ggplot(aes(x = condition, y = number_of_uses)) +
    geom_boxplot() + 
    labs(title = "Side by side boxplots of Number of Uses for a Brick 
    based on Behavior Condition for College Students in a 
    Management Course",
         x = "Behavior Condition",
         y = "Number of uses") 
# Summary statistics
rude %>% 
...
\begin{center}\includegraphics[width=0.6\linewidth]{11-A18-inference-1ofeach-simulation_files/figure-latex/unnamed-chunk-3-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{11-A18-inference-1ofeach-simulation_files/figure-latex/unnamed-chunk-4-1} \end{center}
...
Using the R script file for this activity, enter your answers for question 5 in place of the `xx`'s to produce the bootstrap distribution with 10000 simulations to create a 99\% confidence interval; highlight and run lines 35--39.
...
\begin{center}\includegraphics[width=0.7\linewidth]{11-A18-inference-1ofeach-simulation_files/figure-latex/unnamed-chunk-5-1} \end{center}
