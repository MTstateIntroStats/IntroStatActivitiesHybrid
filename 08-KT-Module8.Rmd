...
* **Simulation methods to create the null distribution**: R code to use simulation methods for two categorical variables to find the p-value, `two_proportion_test` (from the `catstats` package), is shown below.  
