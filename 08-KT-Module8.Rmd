...
* Notation for a difference in sample proportions: $\hat{p}_1 - \hat{p}_2$
...
* **Simulation methods to create the null distribution**: R code to use simulation methods for one categorical variable to find the p-value, `two_proportion_test`, is shown below.  

    ```{r, eval=FALSE, echo=TRUE}
two_proportion_test(probability_success = xx, # Null hypothesis value
