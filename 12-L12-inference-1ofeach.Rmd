...
* Upload and open the R script file for Module 12 lab. Upload the csv file, `Trustworthiness.csv`. 
...
10. Using the provided R script file, enter the T-score (for `xx`) and the `df` calculated in question 9 for `yy` into the `pt()` function.  Determine if we should use lower.tail = TRUE or lower.tail = FALSE to find the appropriate p-value. Highlight and run line 27.  Report the p-value calculated. 
