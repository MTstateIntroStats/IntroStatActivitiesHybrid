## Module 4 Review - Theory-based Methods for a Single Mean
...
```{r simpleNormalcurve, fig.cap="A standard normal curve.", warning=TRUE, out.width="50%", fig.align ="center", echo=FALSE}
openintro::normTail(m = 0, s = 1)
```

```{r Normcurve, warning=TRUE, out.width="50%", fig.align ="center", echo=FALSE}
openintro::normTail(m = 0, s = 1)
```
...
```{r Ncurve, fig.cap="A standard normal curve.", warning=TRUE, out.width="50%", fig.align ="center", echo=FALSE}
openintro::normTail(m = 0, s = 1)
```
