...
```{r pvalue, echo = F, fig.cap = "t-distribution with 41 degrees of freedom"}
...
plot(x, hx, type="l", lty=1, lwd=3, xlab="x value",
  ylab="Density", main="t Distribution with 41 df")
...
```{r tstar, echo = F, fig.cap = "t-distribution with 41 degrees of freedom"}
