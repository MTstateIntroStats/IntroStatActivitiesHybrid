...
* The theory-based **p-value** for hypothesis testing involving proportions can be found by using the `pnorm` function to find the probability of the observed standardized statistic or one more extreme (in the direction of $H_A$). This probability is the area under a standard normal distribution at or more extreme than the observed standardized statistic.
