...
* R code to use for **simulation-based methods** for paired data with a quantitative response to find the p-value, `paired_test` (from the `catstats` package), is shown below.
