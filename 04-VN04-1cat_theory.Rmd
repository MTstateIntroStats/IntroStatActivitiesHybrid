...
```{r simpleNormalc, warning=FALSE, out.width="43%"}
...
\rgi \rgi - If the conditions are met, the sampling distribution which assumes the null hypothesis is true is the standard Normal (N(0,1)) distribution
