...
```{r simpleNormalc, warning=FALSE, out.width="45%"}
...
From the image below, what multiplier ($z^\star$) should be used to create a 95% confidence interval for the parameter?  Explain why 97.5% of the distribution is shaded (why are we using the 97.5th percentile to create a 95% confidence interval?)
