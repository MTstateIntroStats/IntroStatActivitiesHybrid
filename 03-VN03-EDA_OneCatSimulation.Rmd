...
* Two possible outcomes:
    ...
    - Strong evidence against __________________ -> jury finds the defendant ____________________
    
    - Not enough evidence against _____________________ -> jury finds the defendant ______________________
...
* Write the alternative hypothesis in words and in notation:
  ...
  \rgi \rgi In notation:  $H_0: \pi $_________ (a ________ sign represents the research question - that humans have a ___________________ for choosing Bumba on the left)
...
\setstretch{1.5}
  ...
  * The p-value of the test is ________________.  This p-value provides ______________________ evidence against the ________________________ hypothesis and for the ____________________ hypothesis.  The results from this study _________________________ be considered statistically significant.
...
one_proportion_test(probability_success = 0.10, # Null hypothesis value
          ...
          as_extreme_as = 3/62, # Observed statistic
