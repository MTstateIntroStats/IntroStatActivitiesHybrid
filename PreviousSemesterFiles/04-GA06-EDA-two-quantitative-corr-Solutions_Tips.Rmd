...
---
## Guided Activity 6:  IPEDS (continued) Solutions and Tips
...
\textcolor{blue}{Plan to work through the R file with the students explaining how the code was filled in.}
...
\textcolor{red}{Moderately strong, positive, linear relationship with 1 potential outlier at (450,10)}
...
\textcolor{red}{$\widehat{Retention}=0.059 + 0.125 \times SATMath\_75$}
...
\textcolor{red}{$\widehat{Retention}=0.059 + 0.125 \times 440 = 55.059$ percentage points}
...
\textcolor{blue}{Write out the equation for finding the residual.}

\textcolor{red}{residual = 24 - 55.059 = -31.059}
...
\textcolor{red}{$r^2 = 0.767^2 = 0.588$}
...
\textcolor{red}{$r^2 = \frac{138.386 - 59.934}{138.386}=0.589$}
...
\textcolor{blue}{Should be 158451.8}
...
\textcolor{red}{$r^2 = \frac{158451.8-65133.022}{158451.8} = 0.589$}

9.  Write a sentence interpreting the coefficient of determination in context of the problem.

\textcolor{red}{Approximately 56% ofthe variability in the Retention rate for 4-year institutions is explained by the relationship with the 75th percentile SAT Math score.}
...
\textcolor{red}{Very slightly.  The slope of the line for private is steeper than for public.}
