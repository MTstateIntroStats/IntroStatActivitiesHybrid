## Activity Module 4:  Movie Profits --- Correlation and Coefficient of Determination
...
ggplot(aes(x = budget_mil, y = revenue_mil))+  # Specify variables
  ...
  labs(x = "Budget in Millions ($)",  # Label x-axis
       ...
       title = "Scatterplot of Revenue vs. Budget for 
       Movies Released in 2016 with Horizontal Line") + 
    # Be sure to title your plots
  geom_hline(yintercept = 61.87)  # Add regression line
```
