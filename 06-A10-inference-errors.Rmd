...
It is widely reported that the average recovery time for athletes who undergo surgery to repair a torn anterior cruciate ligament (ACL) is 8 months.  Suppose a local physical therapy company hopes to advertise that their rehabilitation program can shorten this average time to recover.  
...
* Use the scale under "Null Hypothesis value $_0$" to change the value to your null value from question 2.
