...
* Upload and open the R script file for Activity 10. Upload the csv file, `mushrooms_edibility.csv`. 
...
* Enter the name of the explanatory variable in line 17

* Enter the name of the response variable in line 17

* Make sure to title your plot.  

* Highlight and run lines 16--22.
...
mushrooms %>% # Data set piped into...
  ...
  labs(title = "Don't forget to include a title!",  # Make sure to title your plot
       x = "Gill Width",   # Label the x axis
...
9.  Report the p-value for the study.
...
11. Report the 90\% confidence interval.
