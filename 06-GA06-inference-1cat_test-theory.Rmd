...
```{r, fig.cap="Simulated Null Distribution with Normal Distribution Overlay", out.width="70%"}
one_proportion_test(probability_success = 0.34,
                    sample_size = 6034,
...
```{r Ncurve, warning=FALSE, out.width="50%", echo = FALSE, fig.align='center', fig.cap="Standard Normal Curve"}
openintro::normTail()
``` 
