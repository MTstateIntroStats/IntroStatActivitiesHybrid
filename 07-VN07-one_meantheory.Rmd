...
\rgi \rgi - If the conditions are met, the sampling distribution which assumes the null hypothesis is true is the $t$-distribution with $n-1$ degrees of freedom
