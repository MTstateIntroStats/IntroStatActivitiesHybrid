...
There are three type of plots used to plot a single quantitative variable: a dotplot, a histogram or a boxplot.  A dotplot of graduation rates would plot a dot for the In-State tuition cost for each 4-year US higher education institution.
